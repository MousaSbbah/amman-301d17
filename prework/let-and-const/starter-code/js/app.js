...
function displayPics(){
  ...
  // because the variable rando  declared as a local variable inside a function and if you try to use this variable out side this function it will be undefined .
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    const liContent =  allProducts[i].name + ' has ' + allProducts[i].votes + ' votes in ' + allProducts[i].views + ' views';
